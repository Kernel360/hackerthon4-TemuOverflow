...
| 이름                                 | 역할           | 담당 업무                                                                                 |
|------------------------------------|--------------|---------------------------------------------------------------------------------------|
| [HoyiTT](https://github.com/HoyiTT) | 백엔드 개발자 (팀장) | 백엔드 CI/CD 구축<br/> CahtBot 화면,API 구현 <br/>오늘의 에러 API, 화면 구현<br/>댓글 API 구현, AI 댓글 기능 구현 |
| [HoyiTT](https://github.com/HoyiTT) | 프론트엔드 개발자    | 메인 페이지 UI/UX, 챗봇 UI                                                                   |
| [HoyiTT](https://github.com/HoyiTT)| 백엔드 개발자      | 게시판 API, AI 답변 생성 기능                                                                  |
